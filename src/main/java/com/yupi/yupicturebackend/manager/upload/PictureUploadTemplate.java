...
public abstract class PictureUploadTemplate {
    ...
    public final UploadPictureResult uploadPicture(Object inputSource, String uploadPathPrefix) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(objectList)) {
                // 获取压缩之后得到的文件信息
                CIObject compresssedCiObject = objectList.get(0);
                // 如果没有缩略图就将其默认为压缩图webp
                CIObject thumbnailCiObject = compresssedCiObject;
                // 只有缩略图大小符合条件才生成缩略图，因此要判断是否存在缩略图
     ...
     * @param compresssedCiObject 压缩后的对象
